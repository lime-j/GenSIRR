...
class DSRTestDataset(BaseDataset):
    ...
    def align(self, x1, x2):
        ...
        if short_side > 1024:
            if h <= w:
                x1 = __scale_height(x1, 1024)
                x2 = __scale_height(x2, 1024)
            else:
                x1 = __scale_width(x1, 1024)
                x2 = __scale_width(x2, 1024)
            h, w = x1.height, x1.width
    ...
    def align(self, x1, x2, x3):
        ...
        if short_side > 1024:
            if h <= w:
                x1 = __scale_height(x1, 1024)
                x2 = __scale_height(x2, 1024)
                x3 = __scale_height(x3, 1024)
            else:
                x1 = __scale_width(x1, 1024)
                x2 = __scale_width(x2, 1024)
                x3 = __scale_width(x3, 1024)
            h, w = x1.height, x1.width
...
class RealDataset(BaseDataset):
    ...
    def align(self, x):
        ...
        if short_side > 1024:
            if h <= w:
                x = __scale_height(x, 1024)
            else:
                x = __scale_width(x, 1024)
            h, w = x.height, x.width
